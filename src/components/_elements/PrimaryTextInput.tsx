...
import { ElementPositionWrapper, Container } from '@/components/_views/styledContainers';
import { SmallText, ValidationText } from '@/components/_views/styledTexts';
...
const PrimaryTextInput = ({
  ...
  return (
    <Container relative mobileWidth={width ? width : '100%'} mobileHeight="70px">
      {label && (
